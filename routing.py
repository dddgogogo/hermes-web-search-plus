...
LANGUAGE_HINT_PROVIDER_BOOSTS: Dict[str, List[Tuple[str, float]]] = {
    "zh": [("local", 10.0), ("exa", 7.0), ("you", 6.0), ("firecrawl", 4.0), ("linkup", 3.0), ("serper", 2.5)],
...
ROUTING_CLASS_PROVIDER_BOOSTS: Dict[str, List[Tuple[str, float]]] = {
    ...
    "official_docs": [("local", 13.0), ("exa", 12.0), ("you", 7.0), ("firecrawl", 5.0), ("serper", 3.0), ("tavily", 2.0)],
    ...
    "github_docs": [("local", 11.0), ("exa", 10.0), ("you", 6.0), ("firecrawl", 5.0), ("serper", 4.0)],
    "docs_api": [("local", 10.0), ("serper", 6.0), ("exa", 5.0), ("you", 4.0), ("firecrawl", 3.0), ("tavily", 3.0)],
    "academic_arxiv": [("local", 13.0), ("exa", 12.0), ("serper", 3.0), ("linkup", 2.0), ("you", 1.5)],
...
class QueryAnalyzer:
    ...
    def analyze(self, query: str) -> Dict[str, Any]:
        ...
        provider_scores = {
            ...
            # DonSeTch: local keyless metasearch (Kata stdio bridge) — primary
            # local default following upstream v4. Base score slightly above
            # firecrawl/tavily so local-first wins on generic queries;
            # specialized intents still pick cloud providers via class boosts.
            "local": research_score + (0.2 * recency_score) + direct_answer_score * 0.7 + 0.6,
        }
